...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "يسير" },
      { name: "twitter:title", content: "يسير" },
      { property: "og:description", content: "يسير is a project management and collaboration platform for teams to manage projects, tasks, contracts, and files." },
      { name: "twitter:description", content: "يسير is a project management and collaboration platform for teams to manage projects, tasks, contracts, and files." },
    ],
    links: [
